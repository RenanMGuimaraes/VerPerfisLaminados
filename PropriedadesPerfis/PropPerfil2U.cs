...
namespace VerPerfisLaminados.PropriedadesPerfis
{
    internal class PropPerfil2U
    {
        public static double area, Ix, Wx, rx, Iy, Wy, ry, x, d, tw, tf, bf, peso, It, Cw;
        public string Plotar2U(int id)
        {
            string perfil;


            Assembly ListaPerfil = Assembly.GetExecutingAssembly();
            StreamReader readerPerfil = new StreamReader(ListaPerfil.GetManifestResourceStream("VerPerfisLaminados.Txt.perfis2U.txt"));
